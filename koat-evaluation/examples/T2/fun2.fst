model main {
  ...
  transition t16 := {
    ...
    action := A' = P, B' = C, D' = E, F' = O, G' = 2, H' = 0, I' = P, J' = O, K' = 2, L' = 4, O' = ?, P' = ?;
  };
  transition t17 := {
    from   := f6;
    to     := f4;
  ...
  transition t18 := {
    ...
    action := A' = 0, B' = C, D' = E, F' = P, G' = O, H' = 0, I' = 0, J' = P, K' = O, L' = 2, O' = ?, P' = ?;
  };
  transition t19 := {
    from   := f4;
    to     := f2;
  ...
  transition t20 := {
    ...
    action := A' = 0, B' = C + 1, D' = E + 1, F' = P, G' = 4, H' = 0, I' = 0, C' = C + 1, E' = E + 1, J' = P, K' = 4, L' = 2, O' = ?, P' = ?;
  };
  transition t21 := {
    from   := f4;
    to     := f7;
